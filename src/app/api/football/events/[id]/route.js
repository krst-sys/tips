...
import { getFootballEvent } from "@/services/football/footballAnalysisService";
...
export async function GET(_request, context) {
  ...
  try {
    const result = await getFootballEvent(id);
    ...
    return errorResponse("Nao foi possivel carregar o jogo agora.", 503, "SERVICE_UNAVAILABLE");
  }
}
